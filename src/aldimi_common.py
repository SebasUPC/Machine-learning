...
(``db_infrastructure.py``) y el dashboard (``streamlit_app_Dash.py``).
...
REGRESSION_MODEL_CANDIDATES = {
    "t+7": ["reg_demanda_t7.joblib", "reg_stock_t7.joblib", "reg_t7_XGBoost.joblib", "reg_t7_RandomForest.joblib"],
    "t+14": ["reg_demanda_t14.joblib", "reg_stock_t14.joblib", "reg_t14_XGBoost.joblib", "reg_t14_RandomForest.joblib"],
}
...
def _yesno_to_int(series: pd.Series) -> pd.Series:
    """Convierte una columna Yes/No, Si/No, true/false o 1/0 a entero 0/1."""
